...
[
  ...
  {time:3.0, value:1.0, tangent_in:0.0, tangent_out: 0.0}, // start jump
  {time:5.0, value:5.0, tangent_in: 0.0, tangent_out:0.0}, // end jump
  {time:5.9, value:1.0, tangent_in: 0.0, tangent_out:0.0}, // first bounce
  {time:6.5, value:1.9, tangent_in: 0.0, tangent_out:0.0}, // first peak
  {time:7.1, value:1.0, tangent_in: 0.0, tangent_out:0.0}, // second bounce
  {time:7.5, value:1.2, tangent_in: 0.0, tangent_out:0.0}, // second peak
  {time:7.9, value:1.0, tangent_in: 0.0, tangent_out:0.0}, // ground
];

const keyframes_alpha = 
[
  {time:0.0, value:0.0, tangent_in:0.0, tangent_out:0.0}, // start
  {time:3.0, value:-12, tangent_in:0.0, tangent_out: 0.0}, // start jump
  {time:5.0, value:-20.0, tangent_in: 0.0, tangent_out:0.0}, // end jump
  {time:5.9, value:-23.6, tangent_in: 0.0, tangent_out:0.0}, // first bounce
  {time:6.5, value:-24.8, tangent_in: 0.0, tangent_out:0.0}, // first peak
  {time:7.1, value:-26, tangent_in: 0.0, tangent_out:0.0}, // second bounce
  {time:7.5, value:-26.4, tangent_in: 0.0, tangent_out:0.0}, // second peak
  {time:7.9, value:-26.8, tangent_in: 0.0, tangent_out:0.0}, // ground
  {time:8.1, value:-27.0, tangent_in: 0.0, tangent_out:0.0}, // ground
  {time:8.3, value:-27.1, tangent_in: 0.0, tangent_out:0.0}, // decelerate
  {time:8.5, value:-27.15, tangent_in: 0.0, tangent_out:0.0}, // decelerate
  {time:8.7, value:-27.175, tangent_in: 0.0, tangent_out:0.0}, // stop
];
